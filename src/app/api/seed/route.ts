...
import { db } from "@/db";
import { users, lessons, posts, reactions, comments, liveEvents, reservations, challenges, challengeProgress, weeklyPhrases, dailyPrompts, checkins, lessonCompletions } from "@/db/schema";
